...
<p align="center"><strong><code>wenxuanjun/barcode-scanner</code></strong></p>
<p align="center">
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/wenxuanjun/barcode-scanner"><img src="https://img.shields.io/npm/l/wenxuanjun/barcode-scanner?style=flat-square" /></a>
<br>
  <a href="https://www.npmjs.com/package/wenxuanjun/barcode-scanner"><img src="https://img.shields.io/npm/dw/wenxuanjun/barcode-scanner?style=flat-square" /></a>
  <a href="https://www.npmjs.com/package/wenxuanjun/barcode-scanner"><img src="https://img.shields.io/npm/v/wenxuanjun/barcode-scanner?style=flat-square" /></a>
...
All releases of this package can be found on [npm](https://www.npmjs.com/package/wenxuanjun/barcode-scanner?activeTab=versions) and on [GitHub Releases](https://github.com/capacitor-community/barcode-scanner/releases)

## Installation

```bash
npm install wenxuanjun/barcode-scanner
npx cap sync
```
...
```js
import { BarcodeScanner } from 'wenxuanjun/barcode-scanner';
...
```ts
import { BarcodeScanner, SupportedFormat } from 'wenxuanjun/barcode-scanner';
